...
export default function PlanPage() {
  ...
  useEffect(() => {
    const storedPlan = sessionStorage.getItem("lodestar-plan");
      ...
      <main className="min-h-screen bg-[#fafaf9] text-[#172018]">
        ...
        <section className="mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg leading-8 text-[#66716b]">
            Tell LODESTAR what's happening and we'll help you find relevant
            resources and decide what to do next.
          </p>
  ...
  const steps: PlanStep[] = plan.actionPlan.map((step, index) => ({
    id: `step-${index}`,
    title: step,
    completed: completed.includes(`step-${index}`),
  }));
    ...
    <main className="min-h-screen bg-[#fafaf9] text-[#172018]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          {/* Needs */}
          <aside className="h-fit rounded-3xl bg-[#173d32] p-7 text-white">
            ...
            <div className="mt-7 border-t border-white/10 pt-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-6 text-white/70">
                  Recommendations are based on verified resources in the
                  LODESTAR database.
                </p>
              </div>
            </div>
        ...
        <div className="mt-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-[#66716b]">
              These recommendations were selected based on the needs LODESTAR
              identified.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-[#66716b]">
                Tell LODESTAR about a different situation and create a new
                path forward.
              </p>
            </div>
